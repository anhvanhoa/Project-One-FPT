...
<body>
    ...
    <main class="mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:max-w-7xl lg:px-8">
        <div class="flex flex-col items-center border-b py-4 sm:flex-row bg-black/70 px-8 rounded-lg text-white">
                            ...
                            <div>
                                <div class="flex justify-between text-base font-medium text-gray-900">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-500 font-normal text-right text-sm">x <?= $amount_buy ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
