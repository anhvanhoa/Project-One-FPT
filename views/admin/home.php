            ...
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4">
                    ...
                    <div class="rounded-xl border-2 bg-indigo-50 p-6 text-indigo-600 border-indigo-600">
                        ...
                        <div class="flex items-end justify-between">
                            <p class="text-3xl font-semibold"><?= $count_product ?></p>
                            <div class="">
                        ...
                        <div class="flex items-end justify-between">
                            ...
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
                                    <path fill="currentColor" d="M18 17a7 7 0 1 0-7-7a7 7 0 0 0 7 7Zm0-12a5 5 0 1 1-5 5a5 5 0 0 1 5-5Z" class="clr-i-outline clr-i-outline-path-1" />
                                    <path fill="currentColor" d="M30.47 24.37a17.16 17.16 0 0 0-24.93 0A2 2 0 0 0 5 25.74V31a2 2 0 0 0 2 2h22a2 2 0 0 0 2-2v-5.26a2 2 0 0 0-.53-1.37ZM29 31H7v-5.27a15.17 15.17 0 0 1 22 0Z" class="clr-i-outline clr-i-outline-path-2" />
