            ...
            <form action="?act=delete-product" method="POST" id="form">
                <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                    <div class="flex mb-4">
                        ...
                        <a href="?act=bin-products" class="text-white bg-gray-500 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Thùng rác</a>
                    </div>
