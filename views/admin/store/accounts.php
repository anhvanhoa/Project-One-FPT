    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Tài khoản cấm</h1>
            </div>
        </header>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <div class="flex mb-4">
                <a href="/admin?act=accounts" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Thêm tài khoản</a>
            </div>
            <main>
                                ...
                                ?>
                                    <tr class="bg-white hover:bg-gray-50 ">
                                        ...
                                        <td class="flex items-center px-6 py-4">
                                            <a href="/admin?act=restore-account&id=<?= $id ?>" class="font-medium text-blue-600  hover:underline">Khôi phục</a>
                                        </td>
                                    </tr>
                                <?php
                                }
        ...
        <div id="overlay" class="hidden relative z-10 ease-out duration-300 opacity-0" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div id="content" class="ease-out duration-300 opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95 flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
