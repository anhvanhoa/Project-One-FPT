            ...
            <div class="mx-auto px-4 max-w-7xl py-6 sm:px-6 lg:px-8">
                <form action="?act=add-product" method="POST">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        ...
                        <button name="add-product" type="submit" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save</button>
                    </div>
                </form>
            </div>
        </main>
